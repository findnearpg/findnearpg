...
const DEFAULT_COMPONENTS = {
  h1: ({ node, ...props }) => <h1 className="font-semibold text-4xl leading-snug" {...props} />,
  h2: ({ node, ...props }) => <h2 className="font-medium text-3xl leading-snug" {...props} />,
  ...
  img: ({ node, alt, ...props }) =>
    alt ? (
      <img {...props} alt={alt} className="mx-auto my-4 rounded" />
    ) : (
      <img {...props} alt="" aria-hidden="true" className="mx-auto my-4 rounded" />
    ),
  table: ({ node, ...props }) => <table className="min-w-full border-collapse" {...props} />,
  thead: ({ node, ...props }) => <thead className="border-gray-200 border-b-2" {...props} />,
  tbody: ({ node, ...props }) => <tbody {...props} />,
  tr: ({ node, ...props }) => <tr className="border-gray-200 border-b" {...props} />,
  th: ({ children }) => <th className="p-2 text-left">{children}</th>,
  td: ({ children }) => <td className="p-2">{children}</td>,
  strong: ({ node, ...props }) => <strong className="font-bold" {...props} />,
  em: ({ node, ...props }) => <em className="italic" {...props} />,
  del: ({ node, ...props }) => <del className="line-through" {...props} />,
  hr: ({ node, ...props }) => <hr className="my-4 border-gray-200 border-t" {...props} />,
};
